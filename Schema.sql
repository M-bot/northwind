...
CREATE TABLE `orders` (
  ...
  `ShipState_Province` varchar(50) DEFAULT NULL,
  `ShipZIP_PostalCode` varchar(50) DEFAULT NULL,
  `ShipCountry_Region` varchar(50) DEFAULT NULL,
